                        ...
                        <div class="form-wrapper">
                            ...
                            <div class="form-content">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" placeholder="Supplier Name" name="name" value="<?php echo $data['name']; ?>">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="date" placeholder="Date" name="date" value="<?php echo $data['date']; ?>">
                                    <span style="color:red; font-size:7px; font-weight:bold">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="time" placeholder="Time" name="stime" value="<?php echo $data['stime']; ?>">
                                    <span style="color:red; font-size:7px; font-weight:bold">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="time" placeholder="Time" name="etime" value="<?php echo $data['etime']; ?>">
                                    <span style="color:red; font-size:7px; font-weight:bold">
                                ...
                                <div class="text-box">
                                    ...
                                    <textarea name="remarks" id="descript" cols="50" rows="5" value="<?php echo $data['remarks']; ?>">
                          </textarea>
                                    <span style="color:red; font-size:7px; font-weight:bold">

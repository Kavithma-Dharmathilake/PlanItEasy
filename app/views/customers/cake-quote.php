                ...
                <form action="<?php echo URLROOT; ?>customers/sendquote/<?php echo $data['supplier']->id ?>/<?php echo $data['request']->id ?>" method="post">
                    ...
                    <div style="display:flex;">
                        <div style="width:20rem; margin-left:2rem">
                            ...
                            <p class="form-text" style="margin-top:1rem;margin-right:2rem">Services</p>
                            <input type="checkbox" id="smokescreen" name="JarCake">
                            <label for="Lunch" style="font-size: 15px;">Jar Cake</label><br />
                            <input type="checkbox" id="Dinner" name="WeddingCake">
                            <label for="Dinner" style="font-size: 15px;">Wedding Cake</label><br />

...
<body>
    <div class="dash-container">
        ...
        <div>
            ...
            <main>
            <form action="<?php echo URLROOT ?>customers/editquote/<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data">
                <div class="form-add-package">
                    <div class="form-wrapper">
                        <div class="form-heading">
                            <h2 style="padding: 20px;">Update Quoate</h2>
                        </div>
                        <div class="form-content">
                            ...
                            <div class="text-box">
                                ...
                                <textarea name="remarks" id="descript" cols="50" rows="5"
                                    value="<?php echo $data['remarks']; ?>">    <?php echo $data['remarks']; ?>    
                          </textarea>

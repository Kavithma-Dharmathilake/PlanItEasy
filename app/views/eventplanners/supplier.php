    ...
    <div class="vendor-grid">
        ...
        <?php foreach ($data['supplier'] as $i) : ?>
            ...
            <div class="vendor-card">
                <a href="<?php echo URLROOT; ?>eventplanners/portfolio/<?php echo $i->id . "/" . $data['request']->id ?>">
                    ...
                    <div class="vendor-details">
                        ...
                        <div class="Vendor-bottom-details">
                            <a href="<?php echo URLROOT; ?>eventplanners/sendquote/<?php echo $i->id . "/" . $data['request']->id ?>">
